...
function sendToVendorPayments(ModOfPayment,DocType,DocDate,CardCode,DocCurrency,CheckAccount,CheckSum,CounterReference,Remarks,U_SourceRef,U_TR_Source,VPM1_CheckNumber,VPM1_BankCode,VPM1_AccounttNum,VPM1_Trnsfrable,VPM1_CheckSum ,VPM1_Currency ,VPM1_CheckAccount ,VPM1_ManualCheck,  TransferAccount,TransferSum,TransferDate,TransferReference,VPM4_AccountCode,U_FundTransfer_To,U_FundTransfer_ToName,VPM4_SumPaid,U_Payment_Method,U_Purpose,U_RemitanceCode,U_ChargeBourned,U_SignatureRequired,U_Approver01,U_Approver02,U_FundTransfer,VPM2_PaymentInvoiceDocEntryList,VPM2_PaymentInvoicePaidSumList,PDN1_AcctCode) {
  ...
  // var getUrl = IP_ADDRESS+'/b1s/v1/PurchaseDeliveryNotes('+documentEntry+')';
  // var options = {
  //   'method': 'get',
  ...
  //   'validateHttpsCertificates': false
  // };
  // var getResponse = UrlFetchApp.fetch(getUrl, options);
  // var getResContent = getResponse.getContentText();
  // var get_json_data = JSON.parse(getResContent);

  // var POTargetEntry=get_json_data['DocumentLines'][0].POTargetEntry;
  // //var POTargetEntry='56';
  // if(POTargetEntry==null ){
  //  return{
  //   sapResponseCode : 401,
  //   sapContentText: "Not found PO target entry number. Please approve this invoice in SAP",
  //  };
...
//   var url = 'https://34.142.197.102:50000/jdbc:sap:hana.sanasa.life:30015/SANASA_LIFE_DEV';
//   var user = 'SYSTEM';
...
//   var query = 'SELECT * FROM PDN1 WHERE "DocEntry" = ?';
  
//   var stmt = conn.prepareStatement(query);
//   stmt.setString(1, documentEntry);
...
//     //   row[meta.TrgetEntry(i)] = results.getString(i);
//     // }
//     // data.push(row);
//   }
